#!/usr/bin/env node
/**
 * Phase 53C2 UX Verifier — SPA-safe shell checks
 * All routes (/, /chat, /tools, /profile, /admin) return index.html (SPA).
 * PASS: each route 200 + HTML contains data-wc-app="1" and at least one Vite marker.
 */
