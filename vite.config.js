      ...
      proxy: {
        "/api": {
          ...
          rewrite: (p) => {
            ...
            if (pathname === "/api/searchLiveResources" || pathname.startsWith("/api/searchLiveResources")) {
              return `/searchLiveResources${qs}`;
            }
        ...
        "/searchLiveResources": {
          ...
          changeOrigin: true,
          secure: false,
          rewrite: (p) => (p.replace(/^\/searchLiveResources/, "/searchLiveResources")),
        },
      },
      headers: {
