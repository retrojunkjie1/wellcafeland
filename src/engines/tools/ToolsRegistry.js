...
export const ToolsRegistry = [
  {
    ...
    description: "Guided 4–7–8 breath for nervous system reset",
    icon: Wind,
    category: "Breathing",
    intensity: "low",
    duration: "3-10 min",
    ...
    instruction: "Follow the orb. Inhale, hold, and exhale with the rhythm.",
    voiceScript: [
  ...
  },
  {
    ...
    description: "Sensory reconnection when anxiety spikes",
    icon: Target,
    category: "Grounding",
    intensity: "low",
    duration: "3-5 min",
    ...
    instruction: "Move through your senses: see, touch, hear, smell, taste.",
    voiceScript: [
  ...
  },
  {
    ...
    durationMinutes: 4,
    sessionType: "panic",
    instruction: "Stay with me. Breathe and follow each simple step.",
    voiceScript: [
      "You are safe",
      "This will pass",
